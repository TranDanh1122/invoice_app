...
function StaticSidebar(): React.JSX.Element {
    ...
    if (width <= 1023) {
        return <>
            <div className='rounded-tr-3xl rounded-br-3xl tb:rounded-none mb:rounded-none bg-[var(--four)] 
            fixed z-20 top-0 left-0 w-full h-20 flex items-center justify-between' >
                ...
                <NavLink to={"/"} className='p-0 flex justify-end gap-6 items-center w-1/2'>
